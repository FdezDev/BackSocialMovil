    ...
    addPublication(userId, description, multimedia) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const createdPublication = yield userPublicationModel_1.default.create({ userId, description, multimedia });
                // Convertir el modelo Sequelize en una instancia del dominio UserPublication
                return new userPublication_1.UserPublication(createdPublication.id, createdPublication.userId, createdPublication.description, createdPublication.multimedia);
            }
            catch (error) {
